...
capture net12 : sudo tcpdump -i enp0s8 -w ping1.pcap
capture net2 : sudo tcpdump -i enp0s3 -w ping2.pcap
...
Puis dhclient sur cette même machine
...
enp0s8: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc pfifo_fast state UP
qlen 1000
